...
const u8 gText_TurboButtonA[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}A");
const u8 gText_TurboButtonL[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}L");
const u8 gText_TurboButtonR[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}R");
